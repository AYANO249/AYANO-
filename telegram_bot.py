#!/usr/bin/env python3
"""
 𝙰𝚈𝙰𝙽𝙾 𝙹𝙸 - بوت التحكم الكامل
طُوِّر بواسطة: ᗴᒪᗰOᗪᗰᗴToken | @LO_RD_1
"""
...
# ========== إعدادات البوت ==========
BOT_TOKEN = "8682708588:AAEx2v6tSRJOWDj1uh5AdPlY__HOspY5-N4"
API_BASE_URL = os.environ.get("API_BASE_URL", "https://mode-host.onrender.com")

# إيدي الأدمن على تليجرام
ADMIN_TELEGRAM_IDS = [7753303031]

# معلومات المطور
DEVELOPER_INFO = "🛠 طُوِّر بواسطة: * 𝐀𝐘𝐀𝐍𝐎 𝐉𝐈*\n📬 تواصل: @LO_RD_1"
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, edit=False):
    ...
    keyboard.append([InlineKeyboardButton("💬 تواصل مع المطور @LO_RD_1", url="https://t.me/LO_RD_1")])
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("💬 تواصل مع المطور @LO_RD_1", url="https://t.me/LO_RD_1")],
    ]
...
async def handle_api_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = api_request("/api/bot/verify", method="POST", data={"api_key": api_key})
    if not result or not result.get("success"):
        keyboard = [[InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/LO_RD_1")]]
        await update.message.reply_text(
            "❌ *مفتاح API غير صالح!*\n\n"
            "تحقق من الكود وحاول مرة أخرى\n"
            "أو تواصل مع المطور: @LO_RD_1",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup(keyboard),
        )
        return WAITING_FOR_API_KEY
